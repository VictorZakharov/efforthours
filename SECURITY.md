...
Do not disclose a suspected vulnerability in a public issue. Once the repository is
published, use the hosting provider's private vulnerability-reporting feature. Until
then, contact the maintainers through the private channel by which you received
access to the repository.

Include the affected version, reproduction steps, impact, and any suggested
mitigation. Do not include real client source or credentials in a report.
