...
`efforthours-public-expansion/0.1.0`. Release identifiers and content checksums are
...
The source archives are not copied into EffortHours. The committed corpus contains
derived labels, stable source-work-item and evidence identifiers, and review
reasoning without source excerpts.

| Repository | Shape | Partition | Release | Source archive SHA256 | License provenance | EffortHours source digest |
|---|---|---|---|---|---|---|
...
and analyzed locally in default static mode. EffortHours did not execute repository
