...
| Manual QA research | `manual-qa-coding-ratio/0.1.0` is development-only; 15 candidate-blind packets and a blank 955-decision compiler template are frozen before answers, compilation, or evaluation |
