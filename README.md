...
| Area | Current status |
| --- | --- |
| Repository EHE | Experimental and uncalibrated; development preflight `0.4.0` rejected the strongest bounded transparent candidate, all 18 validation/test families remain unopened, and no candidate is admitted |
