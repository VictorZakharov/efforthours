...
```text
dotnet tool install --global EffortHours.Tool --version 0.10.0-alpha.20
eh version
```
...
```text
dotnet tool update --global EffortHours.Tool --version 0.10.0-alpha.20
```

See the [`0.10.0-alpha.20` GitHub prerelease](https://github.com/VictorZakharov/efforthours/releases/tag/v0.10.0-alpha.20) for release notes and artifacts.
