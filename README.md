...
| Area | Current status |
| --- | --- |
| Repository EHE | Experimental and uncalibrated; all 15 frozen development families have rubric-complete weak-supervision labels, all 18 validation/test families remain unopened, and no candidate is admitted |
