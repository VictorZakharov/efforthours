...
internal sealed class ChangeCommand
{
    ...
    private static async Task<int> UsageErrorAsync(TextWriter standardError, string message)
    {
        ...
        await standardError.WriteLineAsync("Run 'fairbill change --help' for usage.").ConfigureAwait(false);
    ...
    private const string HelpText = """
        Usage:
          ...
          fairbill change <repository> --base <revision> --head <revision> [options]
