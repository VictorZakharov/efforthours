...
public static class DefaultRateCatalog
{
    private const string ResourceName =
        "EffortHours.Pricing.Rates.UsSeniorContractor.2026.1.json";
    ...
    private static LoadedRateCatalog Load()
    {
        ...
        RateCard rateCard = new()
        {
            ...
            Methodology =
                ...
                $"{model.Formula.WagesAndSalariesPerHour:0.00}), divided by EffortHours's " +
