...
internal static class DockerEvidence
{
    public const string AnalyzerName = "efforthours.docker-analyzer";
    ...
    public static EvidenceFact Fact(
        ...
        IEnumerable<string>? tags = null) => new()
        {
            ...
            Measurements = measurements?
                .OrderBy(measurement => measurement.Name, StringComparer.Ordinal).ToArray() ?? [],
