...
used by the token-backed Python analyzer and now reused unchanged by Go and Java
analyzers `0.1.0`. Its analogous construction rates use wider uncertainty and are
not fitted calibration. The earlier 77 synthetic candidates remain frozen at
0.3.0; the 11 Python, 13 standalone Go, and 13 standalone Java states use 0.4.0.
