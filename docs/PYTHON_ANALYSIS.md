...
The later Go extension advances the current composite source identity to
`change-seed/0.9.0+seed-rules/0.4.0` without changing Python normalization or
valuation behavior.
...
non-SQL, non-Python, non-Go `change-seed/0.6.0` boundary documented in
