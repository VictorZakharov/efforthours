...
and per-repository results without fitting or admitting an interval rule. The first
15-repository, 2,030-target run rejects all 14 direct drivers because every
