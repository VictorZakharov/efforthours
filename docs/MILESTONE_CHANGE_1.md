...
`change-seed/0.14.0+seed-rules/0.4.0`. Version 0.6.0 alone is admitted as the
...
Shell, PowerShell, Terraform/HCL, and PHP/Composer paths. Its ranges are not formal
...
- Formatting exclusion is intentionally conservative and limited to supported
  ...
  Terraform/HCL, and PHP source paths. Script here-documents and here-strings fail
  closed.
