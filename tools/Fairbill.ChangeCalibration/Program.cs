...
internal static class Program
{
    ...
    private static void WriteUsage(TextWriter writer) => writer.WriteLine("""
        Usage:
          dotnet Fairbill.ChangeCalibration.dll --suite <fixtures.json> --output <directory>
          dotnet Fairbill.ChangeCalibration.dll --teacher-policy <policy.json> --index <index.json> --output <plan.json>
        """);
}
