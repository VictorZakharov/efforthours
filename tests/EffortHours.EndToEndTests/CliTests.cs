...
public sealed class CliTests
{
    ...
    public async Task HelpPrintsUsageToStandardOutput()
    {
        ...
        Assert.Contains("eh estimate", result.StandardOutput, StringComparison.Ordinal);
    ...
    public async Task EstimateProducesSchemaVersionedJsonWithoutDiagnosticsOnStandardError()
    {
        ...
        Assert.Equal("seed-rules/0.4.0", document.RootElement.GetProperty("estimatorVersion").GetString());
    ...
    public async Task EstimateCanRenderRecreationMarkdownWithCallerRate()
    {
        ...
        Assert.Contains("Estimator: `seed-rules/0.4.0`", result.StandardOutput, StringComparison.Ordinal);
