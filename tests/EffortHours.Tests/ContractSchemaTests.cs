...
public sealed class ContractSchemaTests
{
    ...
    {
        Assert.Equal(50, ContractSchemaCatalog.Names.Count);
        ...
        Assert.Contains(SchemaNames.ChangePortfolioPreflightReport, ContractSchemaCatalog.Names);
        Assert.Contains(
            SchemaNames.CalibrationManualQaReviewManifest,
            ContractSchemaCatalog.Names);
        Assert.Contains(
        ...
        Assert.Contains(SchemaNames.CalibrationUncertaintyGraphFeatures, ContractSchemaCatalog.Names);
        Assert.Contains(
        ...
        Assert.Contains(SchemaNames.ChangeAuthorPeriodManifest, ContractSchemaCatalog.Names);
        Assert.Contains(SchemaNames.ChangePortfolioBucketManifest, ContractSchemaCatalog.Names);
        Assert.Contains(SchemaNames.ChangePortfolioCapacityManifest, ContractSchemaCatalog.Names);
        Assert.Contains(SchemaNames.ChangePortfolioComparisonReport, ContractSchemaCatalog.Names);
